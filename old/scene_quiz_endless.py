...
class Manager(ScreenManager):
    ...
    def __init__(self, *, appglobals, **kwargs):
        ...
        self._quizstate = attrdict(
            ...
            n_adjectives=None,               # a parameter for quizgenerator.generate_quiz()
            n_choices=None,                  # a parameter for quizgenerator.generate_quiz()
            quiz=None,                         # a quiz returned by quizgenerator.generate_quiz()
            time_increament=None,              # when correct time increase by
            show_all_statements_at_once=None,  # show quiz.question with quiz.facts ?
            n_clear_to_next_level=None,      # number of correct answers to go to next level
            n_cleared=None,                  # number of correct answers
